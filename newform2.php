    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="validation1.php" method="POST" class="sign-in-form">
          ...
          <form action="registration1.php" method="POST" class="sign-up-form">
            ...
            <div class="input-field">
              ...
              <input type="tel" id="phone" name="phone" placeholder="91-99-6784-5432" pattern="[0-9]{2}-[0-9]{2}-[0-9]{4}-[0-9]{4}" required>
            </div>
            <div class="input-field">
              <i class="fas fa-lock"></i>
              <input type="password" name="password" placeholder="Password" />
